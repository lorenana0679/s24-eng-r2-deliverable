...
export default function SpeciesDetailsDialog({ species, currentUser }: { species: Species; currentUser: string }) {
  ...
  const handleDelete = (e: MouseEvent) => {
    ...
    if (!window.confirm("Revert all unsaved changes?")) {
      ...
      return toast({
        title: "Saved changes!",
        description: "Saved your changes, " + input.scientific_name + " has been deeted",
      });
    ...
    <Dialog>
      ...
      <DialogContent className="max-h-screen overflow-y-auto sm:max-w-[600px]">
        <DialogHeader>
          ...
          {species.author && <DialogDescription>{species.author}</DialogDescription>}
        </DialogHeader>
        {/*TODO: Add more here*/}
              ...
              {species.author === currentUser && <div className="flex">
                {isEditing ? (
                  <>
                    ...
                    <Button type="button" onClick={handleDelete} className="ml-1 mr-1 flex-auto" variant="destructive" >
                      Delete
                    </Button>
                  </>
                ) : (
